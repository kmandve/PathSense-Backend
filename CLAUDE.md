...
**Core Value:** A blind user presses a button, and within seconds hears a clear, actionable description of what's directly ahead — obstacles, doors, steps, signs — so they can navigate safely.
